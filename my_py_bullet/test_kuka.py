...
robotId = p.loadURDF("/home/terabotics/gym_ws/my_py_bullet/robots/urdf/iiwa14_rs_scanner_v1.urdf", basePosition=[0,0,0], baseOrientation=[0,0,0,1], useFixedBase=True)
