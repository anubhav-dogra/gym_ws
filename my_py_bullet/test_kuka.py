...
robotId = p.loadURDF("/home/anubhav/gym_ws/my_py_bullet/kuka_env/kuka_env_example/envs/agents/assets/iiwa/urdf/iiwa14_rs_scanner_v1.urdf", basePosition=[0,0,0], baseOrientation=[0,0,0,1], useFixedBase=True)
